 ...
 *      	  | LCD_DATA0  | GPIO2_6
 * ===================================
 * 	Port2 	  | LCD_DATA14 | GPIO0_10
 *       	  | LCD_DATA13 | GPIO0_9
 *		      | LCD_DATA12 | GPIO0_8
 *      	  | LCD_DATA8  | GPIO2_14
 * ===================================
 * 	Port3  	  | GPMC_AD4   | GPIO1_4
 *       	  | GPMC_AD0   | GPIO1_0
 *		      | LCD_VSYNC  | GPIO2_22
 *      	  | LCD_HSYNC  | GPIO2_23
 * ===================================
 * 	H-Bruecke | GPMC_A2    | GPIO1_18
 *        	  | GPMC_A3    | GPIO1_19
 *        	  | GPMC_AD8   | GPIO0_22
 *       	  | GPMC_AD9   | GPIO0_23
 * ===================================
...
//I2C Pins werden erst in Termin 4 benoetigt
#define		CONF_I2C_SCL     0x95c
#define		CONF_I2C_SDA     0x958
